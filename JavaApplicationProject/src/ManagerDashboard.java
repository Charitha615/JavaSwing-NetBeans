...
public class ManagerDashboard extends javax.swing.JFrame {
    ...
    public ManagerDashboard(int userId) {
        initComponents();
        this.userId = userId;
        displayUserInfo(); // Optionally display user-specific information
    ...
    private void initComponents() {
        ...
        ManageSuppliersButton.setText("Click");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addComponent(ManageSuppliersButton)))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            MCustomerOrderViwe mCustomerOrderViwe = new MCustomerOrderViwe(userId);
            mCustomerOrderViwe.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            inventoryManagementForm.setVisible(true);
            this.setVisible(true);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ManagerDashboard.class.getName()).log(Level.SEVERE, null, ex);
        }
